<p align="center">
  <img src="[https://graph.org/file/c413b527220e996344a04.jpg]" alt="Lazy Princess Logo">
</p>
<h1 align="center">
...
Read [this](https://telegram.dog/Tamilan_bots_official/8) before you start messing up with your edits.
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Sebastin123/LazyPrincess">
...
```
## Support
[![telegram badge](https://img.shields.io/badge/Telegram-Group-30302f?style=flat&logo=telegram)](https://telegram.dog/Tamilan_botz_support)
[![telegram badge](https://img.shields.io/badge/Telegram-Channel-30302f?style=flat&logo=telegram)](https://telegram.dog/Tamilan_Bots_Official)

## Credits 
* [![LazyPrincess-Devs](https://img.shields.io/static/v1?label=LazyPrincess&message=devs&color=critical)](https://telegram.dog/Tamilan_Bots_Official)


## Thanks to 
 - Thank you [LazyDeveloper](https://github.com/Sebastin123) for helping us in this journey ❤
 - Thank you [LazyDeveloper](https://github.com/Sebastin123) for adding `file renaming feature` 🎉
 - Thank you [LazyDeveloper](https://github.com/Sebastin123) for keeping this `super premium repo` for `free` ❤
...
[Join Main Channel](https://telegram.dog/Tamilan_bots_official): Tamilan_Bots_officialDeveloper 🎁
